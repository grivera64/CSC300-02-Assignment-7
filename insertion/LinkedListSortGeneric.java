...
public class LinkedListSortGeneric {

    public static <T extends Comparable<T>> void insertionSort(LinkedList<T> list, int n) {
    ...
    public static <T extends Comparable<T>> void insert(LinkedList<T> list, int i) {
